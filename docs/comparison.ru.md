...
| Защита от replay-атак | Слабая | Да | Да | Частичная |
| HMAC с постоянным временем | Нет | Да | — | Да |
| ***Устойчивость к DPI*** | | | | |
| Собственный TLS-бэкенд (TCP splitting) | Да | Да | Нет | Да |
| Dynamic Record Sizing (DRS) | Нет | Да | Да | Нет |
| Мимикрия трафика (DRS + тайминг) | Нет | Да | Да | Нет |
| SOCKS5 upstream-прокси | Нет | Нет | Да | Да |
| ***Контроль доступа*** | | | | |
| Черный / белый список IP | Нет | Да | Да | Нет |
| Лимит уникальных IP на пользователя | Нет | Нет | Нет | Да |
...
| Интеграция с systemd | Частичная | Да | — | Да |
| ***Мониторинг и управление*** | | | | |
| Метрики Prometheus | Нет | Да | Да | Да |
| HTTP-эндпоинт статистики | Да | Да | — | Да |
