...
# Build command using TOML config
# --http-stats must be on CLI (processed before config loading)
CMD="./teleproxy --config $TOML_CONFIG -p $STATS_PORT -c $MAX_CONNECTIONS --http-stats --allow-skip-dh $NAT_INFO_ARGS"
